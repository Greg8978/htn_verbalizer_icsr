...
% Miki put here the details on the supervisor that were in the old version of Execution and monitoring, but verify that they are relevant :) 
...
%describe the domain if needed.




% describe the architecture and interactions between modules on technical aspects (ros request ...)
